      ...
      .map(
        (pokemonData) => `
                    <section class="card animation">
                        ...
                        <header>
                            <h4 class="card-title">${pokemonData.name.charAt(0).toUpperCase()}${pokemonData.name.slice(
          1
        )}</h4>
                            <div class="btn-group">
                                <button class="btn-sm mr-2 disabled" data-type="${pokemonData.type
                                  .substring(0, pokemonData.type.indexOf(','))
                                  .replace(/[^a-zA-Z ]/g, '')}">${pokemonData.type
          .substring(0, pokemonData.type.indexOf(','))
          .replace(/[^a-zA-Z ]/g, '')}</button>
                                <button class="btn-sm disabled" data-type="${pokemonData.type
                                  .substring(pokemonData.type.indexOf(','))
                                  .replace(/[^a-zA-Z ]/g, '')
                                  .trim()}">${pokemonData.type
          .substring(pokemonData.type.indexOf(','))
          .replace(/[^a-zA-Z ]/g, '')
          .trim()}</button>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="centerBlock">   
                                        <div class="circle" data-fill="${
                                          pokemonData.attack
                                        }" hour style="--color:#ef5350">
